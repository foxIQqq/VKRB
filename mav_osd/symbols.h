...
// Прицел
// #define AIM_UL 0xA0 // Верх-лево
// #define AIM_UR 0xA1 // Верх-право
// #define AIM_DL 0xA2 // Низ-лево
// #define AIM_DR 0xA3 // Низ-право
#define SYM_AIM 0xA0 // Прицел состоит из 4 элементов, начиная с этого

// Сплошной квадрат
#define SQUARE_UL 0x06 // Верхний левый угол
#define SQUARE_SL 0x16 // Левая боковинка 
#define SQUARE_SR 0x7C // Правая боковина

// Пунктирный квадрат
#define CROP_SQUARE_UL 0xF0 // Верхний левый угол
#define CROP_SQUARE 0xC0
#define CROP_SQUARE_SL  0xB3 // Левая боковинка 
#define CROP_SQUARE_SR  0xB4 // Правая боковина

// Единичный квадрат
#define PIXEL_SQUARE 0x17      // Сплошной 
#define CROP_PIXEL_SQUARE 0x98 // Пунктирный

// Вытянутый вниз (Ширина 1, Высота H)
#define DOWN_STRETCHED_SQUARE_UP   0xAA // Сплошной
#define CROP_DOWN_STRETCHED_SQUARE_UP 0xF5 // Пунктир
#define CROP_DOWN_STRETCHED_SQUARE 0xD0

// Вытянутый вправо (Ширина W, Высота 1)
#define RIGHT_STRETCHED_SQUARE_LEFT 0xAD // Сплошной
#define CROP_RIGHT_STRETCHED_SQUARE_LEFT 0xFA // Пунктир
#define CROP_RIGHT_STRETCHED_SQUARE 0xD3

#define STATUS_AIM_LOST 0x22      // Статус - цель потеряна
#define STATUS_AIM_NOT_FOUND 0x27 // Статус - цель не найдена

// Состояние упрвления: детектор/ручное/наведение
#define CONTROL_DET 0x10
#define CONTROL_MAN 0x12
#define CONTROL_TRACK 0x14

#define SYM_PLUSD 0xD6
...
#define SYM_SPEED_AIR     0X7F //GPS +1
#else
...
#ifdef ICON_PITCH
#define SYM_PITCH         0X50 // 0XFA 
#else
#define SYM_PITCH         0 
#endif

#ifdef ICON_ROLL
#define SYM_ROLL          0X52 // 0XFB 
#else
#define SYM_ROLL          0 
#endif

#define SYM_YAW           0X59 // Добавлено рыскание
